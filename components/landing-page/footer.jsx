    ...
    >
      ...
      <div className="relative bg-default-900 dark:bg-default-50 py-6">
        <div className="container flex flex-col text-center md:text-start md:flex-row gap-2">
          <p className="text-primary-foreground flex-1 text-base xl:text-lg font-medium">Copyright © {new Date().getFullYear()} Client Onboarding System. All Rights Reserved. Powered By : <a href="https://www.digihost.in/" target="_blank">DIIGIIHOST</a></p>
