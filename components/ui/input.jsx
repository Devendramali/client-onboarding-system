...
export const inputVariants = cva(
  " w-full   bg-[#F5F5F5]  border-border  px-3 h-9   text-sm  file:border-0 file:bg-transparent file:text-sm file:font-medium  read-only:leading-9 read-only:bg-background  disabled:cursor-not-allowed disabled:opacity-50  transition duration-300 ",
  {
    variants: {
      color: {
        default:
          "border-border text-default-500 focus:outline-hidden focus:border-[#1b776f] disabled:bg-default-200  placeholder:text-accent-foreground/50",
        primary:
          "border-[#1b776f] text-[#1b776f] focus:outline-hidden focus:border-[#1b776f] disabled:bg-[#1b776f]/30 disabled:placeholder:text-primary  placeholder:text-primary/70",
