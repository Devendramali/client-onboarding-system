      ...
      <Card  breadcrumbdata={[
        ...
        <div className="flex flex-wrap items-center gap-4 mb-5">
          <div className="flex-1">
            <h3 className="text-3xl font-medium text-[#1b776f] mb-0">User Management</h3>
          </div>
                ...
                <TableCell className="flex gap-3">
                    ...
                    <AlertDialogContent className="max-w-[800px] max-h-[90vh] overflow-y-auto">
                      <AlertDialogHeader>
                        <div className="flex justify-between nx-items-center">
                          ...
                          <h3 className="text-[24px] font-medium text-[#1b776f]  mb-[32px]">User </h3>
                        ...
                        <div className="border border-[#D9D9D9] rounded-[16px] p-[16px]">
                          ...
                          <div className="grid grid-cols-2 gap-[24px]">
                            <div className="lg:col-span-1 col-span-2 col-span-2">
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent className="max-w-[400px]">
                      <AlertDialogHeader>
                        <h2 className="text-[24px] text-[#1A766D] text-center">Are you sure, you want to delete user "John Doe"</h2>
                      </AlertDialogHeader>
